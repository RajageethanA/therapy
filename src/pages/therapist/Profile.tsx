...
export default function Profile() {
  ...
  const therapist = profile || { id: user.id, name: user.name, bio: '', price: 120, specializations: [], languages: [] };
        ...
        <Card className="glass-card md:col-span-2">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="price" type="number" defaultValue={therapist.price} onBlur={async (e) => { const val = Number(e.target.value); if (!Number.isNaN(val) && val !== therapist.price) await save({ price: val }); }} />
            </div>
