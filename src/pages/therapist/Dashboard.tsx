...
import { DollarSign, Users, Calendar, Activity, TrendingUp, Clock, Target, Search, UserCheck, Video, Phone } from 'lucide-react';
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
          <Card className="glass-card hover-lift">
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <span className="text-3xl font-bold">${monthlyEarnings.toLocaleString()}</span>
                <div className="text-right">
                  <div className="text-sm text-muted-foreground">Avg/Session</div>
                  <div className="text-lg font-semibold text-primary">${averageSessionPrice.toFixed(0)}</div>
                </div>
              </div>
              <div className="mt-2 text-sm text-muted-foreground">
        ...
        <Card className="glass-card">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="font-semibold">${monthlyEarnings.toLocaleString()}</div>
                <div className="text-xs text-muted-foreground">
                  ${averageSessionPrice.toFixed(0)} avg/session
                </div>
              </div>
            </div>
