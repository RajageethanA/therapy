import { Home, ClipboardList, Users, Calendar, Brain, Clock, FileText, DollarSign, User, Settings, LogOut, Moon, Sun } from 'lucide-react';
...
const therapistNavItems = [
  ...
  { title: 'Earnings', url: '/therapist/earnings', icon: DollarSign },
